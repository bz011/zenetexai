    ...
    <ol className="mx-auto max-w-md space-y-0">
      {steps.map((step, i) => (
        <li key={step} className="relative pb-6 ps-10 last:pb-0">
          ...
          <span className="absolute start-0 top-0 flex h-8 w-8 items-center justify-center rounded-full border border-indigo-500/30 bg-indigo-500/10 text-small font-semibold text-indigo-400">
            {i + 1}
          </span>
          <p className="pt-1 text-body leading-relaxed text-slate-300">{step}</p>
        </li>
      ))}
    </ol>
  );
    ...
    <div className="min-h-screen ux-page">
      ...
      <section className="relative overflow-hidden border-b border-white/[0.06] px-6 pb-16 md:pb-24 pt-28 md:pt-36">
        ...
        <div className="container-page relative text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lead leading-relaxed text-slate-400">{w.hero_sub}</p>
        ...
        <div className="container-page">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="card p-8">
              ...
              <p className="mt-3 text-body leading-relaxed text-slate-400">{w.compare_chatbot_desc}</p>
            </div>
            <div className="card p-8 border-emerald-500/30">
              <span className="label text-caption text-emerald-400">{w.compare_agent_label}</span>
              <p className="mt-3 text-body leading-relaxed text-slate-300">{w.compare_agent_desc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="automate" className="border-t border-white/[0.06] bg-white/[0.015] px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-body leading-relaxed text-slate-400">{w.automate_sub}</p>
          </div>
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-body leading-relaxed text-slate-400">{w.workflow_sub}</p>
          </div>
      ...
      <section className="border-t border-white/[0.06] bg-white/[0.015] px-6 py-16 md:py-24">
        <div className="container-page max-w-2xl">
          ...
          <p className="mt-4 text-body leading-relaxed text-slate-400">{w.crm_p1}</p>
          <p className="mt-3 text-body leading-relaxed text-slate-400">{w.crm_p2}</p>
          <p className="mt-3 text-body leading-relaxed text-slate-400">{w.crm_p3}</p>
          <p className="mt-4 rounded-xl border border-white/[0.07] bg-white/[0.03] p-4 text-small leading-relaxed text-slate-400">{w.crm_note}</p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-body leading-relaxed text-slate-400">{w.booking_sub}</p>
          </div>
      ...
      {/* Arabic + English */}
      <section className="border-t border-white/[0.06] bg-white/[0.015] px-6 py-12 md:py-16">
        <div className="container-page max-w-2xl text-center">
          <h2 className="text-xl font-bold text-white md:text-2xl">{w.lang_h2}</h2>
          <p className="mt-3 text-body leading-relaxed text-slate-400">{w.lang_p}</p>
        </div>
      </section>
      ...
      <section className="px-6 py-12 md:py-16">
        <div className="container-page max-w-2xl text-center">
          ...
          <p className="mt-3 text-body leading-relaxed text-slate-400">{w.platform_p}</p>
        </div>
      </section>
      ...
      <section className="border-t border-white/[0.06] bg-white/[0.015] px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-body leading-relaxed text-slate-400">{w.security_sub}</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-12 max-w-xl">
            ...
            <p className="mt-3 text-body leading-relaxed text-slate-400">{w.usecases_sub}</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {w.usecases.map((uc) => (
      ...
      <section className="border-t border-white/[0.06] bg-white/[0.015] px-6 py-16 md:py-24">
        <div className="container-page">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-body leading-relaxed text-slate-400">{w.process_sub}</p>
          </div>
      ...
      <section className="border-t border-white/[0.06] px-6 py-16 md:py-24 text-center">
        <div className="container-page">
          <div className="mx-auto max-w-xl">
            ...
            <p className="mx-auto mt-3 max-w-md text-body text-slate-400">{w.cta_sub}</p>
